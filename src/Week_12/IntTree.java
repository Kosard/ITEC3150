 ...
 * <p>
 * This class: This class contains the main blueprint for implementing a binary tree with random integers.
 * <p>
 * Purpose: To show how to use recursion to traverse a binary tree
 */
...
public class IntTree {
    ...
    /**
     * This method counts the number of branch nodes that have even numbers in their data. A branch node is one that has
     * 1 or 2 children (not a leaf node).
     *
     * @param root
     * @return
     */
    ...
    /**
     * This method sums all the nodes in a tree recursively using the preorder traversal way.
     *
     * @param root current parent node
     * @return the total sum of all the nodes
     */
    public int sumNodes(IntTreeNode root) {
        ...
        //Preorder Traversal (NodeLeftRight)
        //Add current node's value to sum
        sum += root.data;

        //Recursive method call on left node of current parent node
    ...
    /**
     * This method counts all the left children nodes in a given binary tree
     *
     * @param root the current node in the tree
     * @return the count of all left children nodes
     */
    private int countLeftNodes(IntTreeNode root) {
        ...
        //Check for left node existence
        if (root.left != null) {
            //Add 1 to count while also recursively call method for left and right child nodes
            count += 1 + countLeftNodes(root.left) + countLeftNodes(root.right);
        }
