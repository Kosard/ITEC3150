 ...
 * <p>
 * This class describes the fields and methods of the custom MediaHashMap, a derivative of the HashMap class that
 * implements Strings as the keys and Media objects as the values.
 * <p>
 * Purpose: To show the implementation of a custom HashMap class
 */
public class MediaHashMap<String, Media> implements MyMap<String, Media> {
    ...
    LinkedList<Entry<String, Media>>[] table;
    ...
    public Set<Entry<String, Media>> entrySet() {
        Set<MyMap.Entry<String, Media>> set =
                new HashSet<Entry<String, Media>>();
     ...
     */
    public Set<Media> values() {
        Set<Media> set = new java.util.HashSet<>();
